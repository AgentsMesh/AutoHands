//! DOM processor for merging CDP trees and calculating clickability.
//!
...
use super::dom_types::NodeAttributes;
...
impl DomProcessor {
    ...
    pub fn calculate_clickability_score(
        ...
        // Detected from attribute names starting with "on" -- handled in JS bridge
