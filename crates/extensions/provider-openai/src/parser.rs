//! Response parsing for OpenAI API.

use autohands_protocols::provider::{ChunkType, CompletionChunk, CompletionResponse, ToolCallChunk};
...
mod tests {
    ...
    fn test_parse_response() {
        ...
        assert_eq!(result.message.content.text(), "Hello!");
    ...
    fn test_parse_response_empty_choices() {
        ...
        let result = parse_response(response);
        assert_eq!(result.message.content.text(), "");
    }
    ...
    fn test_parse_stream_chunk_content() {
        ...
        assert_eq!(result.delta, Some("Hello".to_string()));
    }
    ...
    #[test]
    fn test_parse_stream_chunk_tool_delta() {
        let chunk = StreamChunk {
            id: "test".to_string(),
            choices: vec![StreamChoice {
                index: 0,
        ...
        let result = parse_stream_chunk(chunk);
        assert!(matches!(result.chunk_type, ChunkType::ToolUseDelta));
    }
